...
public interface PantsProjectInfoModifierExtension {
  ExtensionPointName<PantsProjectInfoModifierExtension> EP_NAME = ExtensionPointName.create("com.eslgaming.engineering.intellij-pants-plugin.projectInfoModifier");
