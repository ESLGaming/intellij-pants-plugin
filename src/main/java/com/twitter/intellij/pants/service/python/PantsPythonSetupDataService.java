...
public class PantsPythonSetupDataService implements ProjectDataService<PythonSetupData, Module> {
  ...
  public void importData(
    Collection<? extends DataNode<PythonSetupData>> toImport,
  ...
  public @NotNull Computable<Collection<Module>> computeOrphanData(
    Collection<? extends DataNode<PythonSetupData>> collection,
  ...
  public void removeData(
    Computable<? extends Collection<? extends Module>> computable,
    Collection<? extends DataNode<PythonSetupData>> collection,
    @NotNull ProjectData data,
    @NotNull Project project,
    @NotNull IdeModifiableModelsProvider provider
